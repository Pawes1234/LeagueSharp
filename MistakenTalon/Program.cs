...
namespace MistakenTalon
{
    static class Program
    {
        ...
        static void Orbwalking_AfterAttack(AttackableUnit unit, AttackableUnit target)
        {
            ...
            if (!unit.IsMe || !spells[0].IsReady() || !(target is Obj_AI_Hero)) return;
            spells[0].Cast();
        ...
        private static void CastR(bool isPacketCasting)
        {
            ...
            Utility.DelayAction.Add(50, () => { spells[3].Cast(isPacketCasting); });
        }
        ...
        private static void CastSpells(Obj_AI_Hero currTarget, bool isPacketCasting)
        {
            ...
            if (ObjectManager.Player.Distance(currTarget) <= ObjectManager.Player.AttackRange)
                ObjectManager.Player.IssueOrder(GameObjectOrder.AttackUnit, currTarget);
